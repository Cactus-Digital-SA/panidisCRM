        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group row mb-3 mt-1">
                    <div class="col-lg-6">
                        <label for="erpId" class="col-form-label">ERP ID</label>
                        <div class="col-md-12">
                            <input type="text" name="erpId" class="form-control" placeholder="ERP ID" value="{{ old('erpId', $company->getErpId()) }}" maxlength="100" />
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row mb-3 mt-1">
                    <div class="col-lg-6">
                        <label for="name" class="col-form-label">Όνομα <i class="fa fa-asterisk fa-2xs text-danger"></i></label>
                        <div class="col-md-12">
                    ...
                    <div class="col-lg-6">
                        <label for="typeId" class="col-form-label">Κατηγορία Πελάτη <i class="fa fa-asterisk fa-2xs text-danger"></i></label>
                        <div class="col-md-12">
                ...
                <div class="form-group row mb-3 mt-1">
                    <div class="col-lg-6">
                        <label for="countryId" class="col-form-label">Χώρα</label>
                        <div class="col-md-12">
                    ...
                    <div class="col-lg-6">
                        <label for="countryId" class="col-form-label">Πόλη</label>
                        <div class="col-md-12">
                ...
                <div class="col-12 text-center pt-4 pt-50">
                    <button type="submit" class="mt-4 btn btn-primary me-1">
