                ...
                <div class="col-lg-10 offset-lg-1">
                    <div class="card mt-2 pb-4">
                        <div class="card-header p-4 justify-content-center">
                            <h4 class="card-title">Δημιουργία πεδίου</h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <form id="createExtraDataForm" action="{{ route('admin.extraData.store') }}" method="POST" class="row gy-1 pt-75" enctype="multipart/form-data">
                                    @csrf()
                                    <div class="row d-flex align-items-end mb-50 justify-content-center">
                                        <div class="col-10 mb-2">
                                            ...
                                            <input type="text" id="name" name="name" placeholder="Όνομα" class="form-control" required/>
                                        </div>
                                        <div class="col-10 mb-2">
                                            <label for="description" class="form-label fw-bolder">Περιγραφή</label>
                                            <input type="text" id="description" name="description" placeholder="Περιγραφή" class="form-control"/>
                                        </div>
                                        <div class="col-10 mb-2">
                                        ...
                                        <div class="col-10 mb-2 row">
                                            ...
                                            <div class="col-sm-10 col-md-11" id="repeater"></div>
                                        </div>
                                        <div class="col-10 mb-2">
                                            <label for="required" class="form-label fw-bolder">{{__('Required') }} </label>
                                            <div class="form-check form-switch">
                                                <input type="checkbox" id="required" name="required" class="form-check-input float-start" value="1">
                                            </div>
                                        </div>
                                        <div class="col-10 mb-2">
                                            <label for="multiple" class="form-label fw-bolder">{{__('Multiple') }} </label>
                                            <div class="form-check form-switch">
                                                <input type="checkbox" id="multiple" name="multiple" class="form-check-input float-start" value="1">
                                            </div>
                                        </div>
                                    </div>
