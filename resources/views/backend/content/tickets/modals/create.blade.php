    ...
    <div class="modal-dialog modal-dialog-centered modal-xl two-factor-auth-apps">
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 px-sm-5 mx-50">
                ...
                <form id="form" method="POST" action="{{ route('admin.tickets.store') }}" class="row g-3"
...
{{--                            <i class="fa fa-asterisk fa-2xs text-danger"></i>--}}
                    ...
                    <div class="col-12 col-md-6 @if(isset($hideCompany) ?? false) d-none @endif">
                        <label class="form-label">{{__('Company') }}
{{--                            <i class="fa fa-asterisk fa-2xs text-danger"></i>--}}
                        </label>
...
{{--                            <i class="fa fa-asterisk fa-2xs text-danger"></i>--}}
                        ...
                        <select multiple name="assignees[]"
                                class="form-select select2 select_assignees"
                                data-placeholder="{{ __('Assignees Selection') }}" data-allow-clear="true">
                        </select>
                    </div>
