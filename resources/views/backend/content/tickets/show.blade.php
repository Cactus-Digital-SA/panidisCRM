                            ...
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <div class="card-header-elements ms-auto">
                                    <a href="{{ route('admin.tickets.edit', [$ticket->getId()] ) }}"
                                       class="btn btn-xs btn-primary waves-effect waves-light"><span
                                            class="tf-icon fa fa-pen fa-xs me-1"></span>{{__('Edit')}}</a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <span class="d-block font-small-4"> {{  $ticket->getSource() ?: '-' }} </span>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label"> {{__('Estimation Time')}} </label>
                                        <span class="d-block font-small-4"> {{  $ticket->getEstTime() }} </span>
                                    </div>
                                </div>
