...
@section('title', 'Δημιουργία Quote')
...
@section('content')
    <form id="quotesForm" method="POST" action="{{ route('admin.quotes.store') }}" class="form-horizontal needs-validation" enctype="multipart/form-data" novalidate>
        @csrf
        <div class="card">
                <div class="card-body">
                    <div class="form-group row mb-4 mt-4">
                        ...
                        <div class="col-lg-6 ">
                            ...
                            <div class="col-md-12">
                                <input type="text" name="title" class="form-control" placeholder="Τίτλος Quote" maxlength="255" required/>
                            ...
                            <table class="table" id="itemsTable">
                                ...
                                <tbody id="routes-table-body">
                                    <tr class="item-row">
                                        ...
                                        <td class="col-md-1">
                                            <input type="text" name="items[0][color]" class="form-control" placeholder="Χρώμα">
                                        </td>
                                        <td class="col-md-1">
                                            <input type="number" name="items[0][quantity]" class="form-control" min="0" step="0.01" placeholder="Ποσότητα" onwheel="this.blur()" required>
                                        </td>
                                        <td class="col-md-1">
                        ...
                        <div class="col-xl-6 col-xxl-5">
                            <table class="table sumTable">
                                    ...
                                    <td class="text-end">
                                        <select id="payment_terms" name="payment_terms" class="select2 form-select text-end" data-placeholder="Payment Terms">
                                            ...
                                            @foreach(\App\Domains\Quotes\Enums\PaymentTermsEnum::cases() as $paymentTerm)
                                                <option value="{{ $paymentTerm->value }}">{{ $paymentTerm->label() }}</option>
                                            @endforeach
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <textarea id="delivery_terms" name="delivery_terms" class="form-control text-end" rows="2" placeholder=""></textarea>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                                            ...
                                            <div class="input-group">
                                                <select id="tax_rate" name="tax_rate" class="form-select text-end" style="max-width: 90px;">
                                                    @foreach (App\Domains\Quotes\Enums\TaxRatesEnum::cases() as $rate) {
                                                        <option value='{{$rate->value}}' @if($rate->value == '24') selected @endif>{{$rate->label()}}</option>
                                                    @endforeach
                                                </select>
                                                <input type="number" id="tax" name="tax" class="form-control text-end" value="0.00" readonly>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <input type="number" id="total" name="total" class="form-control text-end fw-bold" value="0.00" readonly>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
